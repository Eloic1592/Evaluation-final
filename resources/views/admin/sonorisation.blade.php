@extends('forme.forme')
@section('title') Liste des sonorisations @endsection

@section('content')
<div class="pagetitle">
      <h1>Liste des sonorisations</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Liste des sonorisations</a></li>

        </ol>
      </nav>
    </div>

    <p><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#largeModal"><a style="color:white;">Nouvelle sono</a></button></p>

    <div class="modal fade" id="largeModal" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Nouvelle sono</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <form class="row g-3" action="{{ url('Sonorisation/create') }}" method="POST">
                @csrf
                <div class="col-md-12">
                        <div class="form-floating">
                        <input type="text" name="sonorisation" class="form-control" id="floatingZip" placeholder="sonorisation"  />

...
class logistique extends Model
{
    ...
    protected $fillable = ['id','logistique','tarif_jour','prixbase','idtype','etat'];
    public $timestamps = false;

    public function modifier(){
        $url = url('Logistique/show/' . $this->attributes['id']);

...
class v_liste_evenement extends Model
{
    protected $table = "v_liste_evenement";
    protected $fillable = ['id','nom','description','date_debut','date_fin','idtype_evenement','etat','type_evenement'];

...
class recette extends Model
{
    ...
    protected $fillable = ['id','iddevis','idlieu','idcategorie_place','nombrevendu','daterecette','etat'];
    public $timestamps = false;

    public function modifier(){
        $url = url('Recette/show/' . $this->attributes['id']);

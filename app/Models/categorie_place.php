...
class categorie_place extends Model
{
    protected $table = "categorie_place";
    protected $fillable = ['id','categorie_place','etat'];
    public $timestamps = false;

    public function modifier(){
        $url = url('CategoriePlace/show/' . $this->attributes['id']);

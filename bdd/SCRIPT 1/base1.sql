...
select d.*,e.nom from devis d join evenement e on d.idevenement=e.id;
...
select d.*,a.artiste,a.tarif_heure from devisartistes d join artiste a on d.idartiste=a.id;
...
select d.*,l.lieu from devislieu d join lieu l on d.idlieu=l.id;
